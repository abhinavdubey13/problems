...
/**
 * Given an set of integers and a SUM, the task is to count all subsets of given set with sum equal to given sum.
 * 
 * u can choose an element from set only once.
 * 
 * ==========
 * example : 
 * ==========
...
class p22_numberOfWaysToFormSum {
    ...
    static int calulator(int SUM, int[] set) {
        ...
        // 1st column : only 1 way to form sum=0
