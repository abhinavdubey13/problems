...
class p37_next_greater_number_with_same_digits {

    public static void main(String[] args) {
        // int arr[] = { 5, 3, 4, 9, 7, 6 }; // expected = 5 3 6 4 7 9
        // int arr[] = { 5, 4, 3, 2, 1 }; // expected = not possible
        // int arr[] = { 1, 2, 5, 4, 6, 7 }; // expected = 1 2 5 4 7 6

        // int arr[] = { 3, 4, 7, 2, 2, 6, 4, 1 }; // expected = 3 4 7 2 1 2 4 6 
        // int arr[] = { 4, 7, 9 }; // expected = 4,9,7
        int arr[] = { 4, 9, 7 }; // expected = 7,4,9
