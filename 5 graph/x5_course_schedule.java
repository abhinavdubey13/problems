...
public class x5_course_schedule {
    ...
    public static void main(String[] args) {
        ...
        boolean answer = Solution.function(numCourses, prerequisites);
...
class Solution {
    ...
    static boolean function(int numCourses, int[][] prerequisites) {
        ...
        return (topological_order.size() == numCourses);
    }
