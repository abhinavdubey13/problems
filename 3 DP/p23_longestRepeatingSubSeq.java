 ...
 * 
 * i.e : all i’th character in the two subsequences should have the unique index in the original string.
 * 
 * ==========
 * example :
 * ==========
 * str = aabcbxyc
 * 
 * longest repeating = abc
 * each of whose char occurs twice (and at different idx)
 * 
 * 
 */
