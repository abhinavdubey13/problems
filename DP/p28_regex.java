...
// NOTE : in the given patterns : * means 0 or more occurance of the character before it
// NOTE : in the given patterns : . means exactly 1 character (it can be any char)
        ...
        for (int i = 1; i <= sample.length; i++) {
            for (int j = 0; j <= pattern.length; j++) {
                ...
                if (sample[i - 1] == pattern[j - 1] || pattern[j - 1] == '.') {
                    ...
                    // considering either zero or atleast 1 occurance in sample string
