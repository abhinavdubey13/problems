 ...
 * 
 * else{
 *  case1 = 1 + steps to form TS(0...i-1) from SS(0...j)     ie. 1 + above cell
 *  case2 = 1 + steps to form TS(0...i) from SS(0...j-1)     ie. 1 + left cell
 *  case3 = 1 + steps to form TS(0...i-1) from SS(0...j-1)   ie. 1 + diagonal cell
